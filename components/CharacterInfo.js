...
export default function CharacterInfo({ name, job, bankBalance, countryFlag }) {
  return (
    <div className="bg-trans-pink p-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            <div className="font-bold text-base sm:text-lg text-text-dark">{countryFlag} {name}</div>
